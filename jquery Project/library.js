...
$(function () {
    ...
    window.book1 = new newBook("The Giver", "Erik R.", 345, "03/03/2001");
    window.book2 = new newBook("Harry Potter", "J.K R.", 234, "03/04/2001");
    window.book3 = new newBook("Crime", "Jack Smith", 363, "03/05/2001");
    window.book4 = new newBook("Mystery", "John Doe", 868, "03/06/2001");
    window.book5 = new newBook("The Time", "Jack Smith", 363, "03/05/2001")
});
...
library.prototype._bindEvents = function (){
  $("#addBook").on ("click",$.proxy(this.addBook, this));  
};
